...
const Signup = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      <div className="absolute inset-0 bg-center min-h-screen bg-[url('/MainLogomobile.jpg')] sm:bg-[url('/MainLogo2.jpg')] bg-[length:110%]"></div>
      {/* <div className="absolute inset-0 bg-black opacity-5"></div> */}
      <div className="relative text-black w-full max-w-[350px] md:py-5 mx-3 my-5 bg-white sm:px-5 shadow-smallShadow bg-opacity-5 backdrop-filter backdrop-blur-[16px] rounded-md flex flex-col p-3 space-y-4">
