...
const Login = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative text-black w-full max-w-[350px] md:py-5 mx-3 my-5 bg-black sm:px-5 shadow-smallShadow bg-opacity-10 backdrop-filter backdrop-blur-[8px] rounded-md flex flex-col p-3 space-y-4">
        ...
        <div className="mt-3 text-center text-white">
          <span className='text-[13px]'>
            ...
            <Link href="/register" className="text-primary2  hover:underline font-bold">
